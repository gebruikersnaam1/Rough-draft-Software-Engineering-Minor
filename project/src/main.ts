...
let query2 = dbTables.Students().Select("Id","Lastname","Prefix","Gender").OrderBy("Lastname","ASC").Where("Id","LessThan","6").Include().SelectGradeStates("Course_Name","Teacher").Commit()
query2.printRows()
