...
//5 Communicatie
utils_1.Cons(models.Students(11, "Jurgen", "", "Redelijkheid", CreateGrades(), models.Gender("Man"), cmi2), utils_1.Cons(models.Students(12, "Joey", "van der", "Heiden", CreateGrades(), models.Gender("Man"), cmi2), utils_1.Cons(models.Students(13, "Marvin", "", "IDK-Lamens", CreateGrades(), models.Gender("Man"), cmi2), utils_1.Cons(models.Students(14, "Roos", "van der", "Flodder", CreateGrades(), models.Gender("Women"), cmi2), utils_1.Cons(models.Students(15, "Sara", "van der", "Flodder", CreateGrades(), models.Gender("Women"), cmi2), 
//5 technische
