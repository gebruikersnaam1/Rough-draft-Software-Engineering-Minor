...
var query2 = Database_1.dbTables.Students().Select("Id", "Lastname", "Prefix", "Gender").OrderBy("Id", "ASC").Where("Id", "LessThan", "20").Include().SelectGradeStates("Course_Name", "Teacher").Commit();
query2.printRows();
